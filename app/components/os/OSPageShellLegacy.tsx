...
import {
  Bell, Building2, CalendarDays, ChartNoAxesCombined, ChevronLeft,
  FileChartColumn, Hotel, LayoutDashboard, Loader2, LogOut, Megaphone,
  Menu, QrCode, Settings, Sparkles, Star, Users, Wrench, X, Zap,
} from "lucide-react";
...
export default function LegacyOSPageShell({
  title,
    ...
    <main className={styles.shell}>
      <aside className={`${styles.sidebar} ${mobileOpen ? styles.open : ""}`}>
        <div className={styles.brand}>
          <span className={styles.logo}><Hotel size={21} /></span>
          <div>
